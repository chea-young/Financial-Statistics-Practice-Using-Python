...
# 포트폴리오 수익률의 분산을 계산합니다. portfolio_variance2 = np.dot(np.dot(weight, cov_np), weight.T)
...
portfolio_variance = []
weight_list = np.zeros(shape=(1000,2))
...
# 점의 색깔은 샤프비율(기대수익률/기대변동성)을 나타냅니다. # 그래프에서 의미가 있는 점은 3군데 입니다. 
