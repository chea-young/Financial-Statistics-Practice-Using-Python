...
#%% 날짜 관련 데이터는 시간 관련 작업을 할 수 있도록 datetime자료형으로 바꾸는 것이 좋음
...
# 이러한 데이터 섞기는 통계학에서 bootstrap방법(어떤 통계량의 표준오차를 구하기 위한 비모수적 방법)이나
# 금융에서 역사적 시뮬레이션 (historical simulation)에서 많이 사용
#%% 데이터프레임의 열 삭제하기
scientists_dropped=scientists.drop(['Age'], axis=1) # NOTE Age 열 삭제
